...
import com.grgbanking.demo.common.AppConfig;
import com.grgbanking.demo.common.util.crash.AppCrashHandler;
import com.grgbanking.demo.common.util.sys.SystemUtil;
import com.grgbanking.demo.config.preference.Preferences;
import com.grgbanking.demo.config.preference.UserPreferences;
import com.grgbanking.demo.contact.ContactHelper;
...
public class NimApplication extends Application {
    ...
    public static final int PERMISSION_REQUEST_AUDIO = 201;
    public static final int PERMISSION_REQUEST_CALL_PHONE = 202;
    public static final int PERMISSION_REQUEST_CAMERA = 203;
    public static final int PERMISSION_REQUEST_EXTERNAL_STORAGE = 204;
    /**
    ...
    private SDKOptions getOptions() {
        ...
        // 通知铃声的uri字符串
        config.notificationSound = "android.resource://com.grgbanking.demo/raw/msg";
