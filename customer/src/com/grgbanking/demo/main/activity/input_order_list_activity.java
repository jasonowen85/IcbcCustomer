    ...
    class ListAdapt_1 extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (datas1.get(position).getSchedule().equals("12") || datas1.get(position).getSchedule().equals("2")) { //   ---  action1 撤单， action2 录入快递号
                ...
                if (datas1.get(position).getExpress().equals(null) || datas1.get(position).getCourierNum().equals(null)|| datas1.get(position).getExpress().equals("")||datas1.get(position).getCourierNum().equals("")) {
